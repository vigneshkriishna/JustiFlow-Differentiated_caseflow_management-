...
class SimpleSmartSchedulingService:
    ...
    def get_available_slots_simple(
        ...
        try:
            ...
            if not benches:
                ...
                default_bench = Bench(
                    name="Default Bench", court_number="1", is_active=True
                )
            ...
            return {
                ...
                "availability_rate": (available_slots / total_slots * 100)
                if total_slots > 0
                else 0,
    ...
    def suggest_optimal_schedule_simple(
        self, session: Session, days_ahead: int = 14
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "recommended_strategy": self._simple_strategy_recommendation(
                    pending_cases
                ),
            }
            ...
            unscheduled_cases = [
                {
                    ...
                    "reason": "Limited test scheduling",
                }
                for case in cases[5:]
            ]
    ...
    def _generate_sample_slots(
        self, start_date: datetime, end_date: datetime, benches: List[Bench]
    ) -> List[Dict]:
