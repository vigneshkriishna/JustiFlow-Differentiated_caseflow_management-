    ...
    try:
        ...
        executive_summary = {
            ...
            "key_highlights": {
                ...
                "bns_classification_rate": bns["classification_overview"][
                    "classification_rate"
                ],
                "average_resolution_days": cases["resolution_metrics"][
                    "average_resolution_days"
                ],
                "system_activity": activity["activity_overview"][
                    "total_actions_30_days"
                ],
...
async def get_real_time_metrics(
    ...
    try:
        ...
        combined_metrics = {
            ...
            "ai_insights": {
                "model_performance": advanced_metrics["performance_metrics"][
                    "ml_accuracy"
                ],
...
async def get_predictive_analytics(current_user: User = Depends(get_current_user)):
    """
    ...
    try:
        ...
        enhanced_data = {
            "overview": {
                **dashboard["overview"],
                "ai_enhanced": True,
                "model_accuracy": real_time_metrics["performance_metrics"][
                    "ml_accuracy"
                ],
                "prediction_confidence": real_time_metrics["confidence_distribution"][
                    "high"
                ],
            },
            ...
            "performance_summary": {
                ...
                "bns_classification": real_time_metrics["performance_metrics"][
                    "classification_rate"
                ],
                "scheduling_efficiency": predictive_analytics["resource_optimization"][
                    "efficiency_score"
                ],
